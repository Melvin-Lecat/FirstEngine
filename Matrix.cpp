...
Matrix Matrix::operator +(Matrix v) { return Matrix(this->a + v.a, this->b + v.b, this->c + v.c, this->d + v.d, this->e + v.e, this->f + v.f, this->g + v.g, this->h + v.h, this->i + v.i); }
Matrix Matrix::operator +=(Matrix v) { return Matrix(this->a + v.a, this->b + v.b, this->c + v.c, this->d + v.d, this->e + v.e, this->f + v.f, this->g + v.g, this->h + v.h, this->i + v.i); }
Matrix Matrix::operator - (Matrix v) { return Matrix(this->a - v.a, this->b - v.b, this->c - v.c, this->d - v.d, this->e - v.e, this->f - v.f, this->g - v.g, this->h - v.h, this->i - v.i); }
Matrix Matrix::operator -= (Matrix v) { return Matrix(this->a - v.a, this->b - v.b, this->c - v.c, this->d - v.d, this->e - v.e, this->f - v.f, this->g - v.g, this->h - v.h, this->i - v.i); }
Matrix Matrix::operator * (Matrix v) { return Matrix((this->a * v.a) + (this->b * v.d) + (this->c * v.g),     (this->a * v.b) + (this->b * v.e) + (this->c * v.h),     (this->a * v.c) + (this->b * v.f) + (this->c * v.i),    (this->d * v.a) + (this->e * v.d) + (this->f * v.g),     (this->d * v.b) + (this->e * v.e) + (this->f * v.h),     (this->d * v.c) + (this->e * v.f) + (this->f * v.i),    (this->g * v.a) + (this->h * v.d) + (this->i * v.g),     (this->g * v.b) + (this->h * v.e) + (this->i * v.h),     (this->g * v.c) + (this->h * v.f) + (this->i * v.i)); }
Matrix Matrix::operator *= (Matrix v) { return Matrix((this->a * v.a) + (this->b * v.d) + (this->c * v.g),     (this->a * v.b) + (this->b * v.e) + (this->c * v.h),     (this->a * v.c) + (this->b * v.f) + (this->c * v.i),    (this->d * v.a) + (this->e * v.d) + (this->f * v.g),     (this->d * v.b) + (this->e * v.e) + (this->f * v.h),     (this->d * v.c) + (this->e * v.f) + (this->f * v.i),    (this->g * v.a) + (this->h * v.d) + (this->i * v.g),     (this->g * v.b) + (this->h * v.e) + (this->i * v.h),     (this->g * v.c) + (this->h * v.f) + (this->i * v.i)); }
Matrix Matrix::operator * (float k) { return Matrix(this->a * k, this->b * k, this->c * k, this->d * k, this->e * k, this->f * k, this->g * k, this->h * k, this->i * k); }
Matrix Matrix::operator *= (float k) { return Matrix(this->a * k, this->b * k, this->c * k, this->d * k, this->e * k, this->f * k, this->g * k, this->h * k, this->i * k); }
